  ...
  return (
    <div className={css.box}>
      <div className={css.container}>
        <p className={css.textBar}>{t("homePage.today")}</p>
        <div className={css.progressBar}>
          <div className={css.progress} style={{ width: `${progress}%` }}></div>
          <div
            className={css.thumb}
            style={{ left: `${changedProgress}%` }}
          ></div>
        </div>
        ...
        <div className={css.progressView}>
          <div className={css.holderBox}>
            ...
            <span
              className={`${css.holder} ${
                progress > 32 && progress < 60 ? `${css.hidden}` : ``
              }`}
            >
              50%
            </span>
          ...
          <span
            ...
            style={{ left: `${changedProgress / 1.16}%` }}
          >
            {progress}%
          </span>
        </div>
